-- Script para agendar a Edge Function "weekly-production-report" no Supabase usando pg_cron
...
SELECT cron.unschedule('weekly-production-report-job');

-- 3. Criar o agendamento
-- '0 8 * * 1' significa: Toda Segunda-feira (1) às 08:00 da manhã
SELECT cron.schedule(
    'weekly-production-report-job',
    '0 8 * * 1',
    $$
    SELECT net.http_post(
        url := 'https://xjryvzmejpzwzuroquur.supabase.co/functions/v1/weekly-production-report',
